  ...
  function (req, res) {
    ...
    db.getuserid(email, function (err, result) {
      ...
      var output =
        ...
        username +
        `, </p>
            <p>Gracias por registrarte. Su identificación de verificación y token se proporcionan a continuación
            :  </p>
      ...
      res.send("Revise su correo electrónico para obtener un token para verificar");
    });
