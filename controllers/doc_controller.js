...
var storage = multer.diskStorage({
    destination: function(req, file, cb) {
      cb(null, "public/assets/images/upload_images"); //aquí especificamos el destino. en este caso especifiqué el directorio actual
    },
    filename: function(req, file, cb) {
      console.log(file); //registrar la información del objeto del archivo en la consola
      cb(null, file.originalname);//aquí especificamos el nombre para guardar el archivo. en este caso. 
  //Especifiqué el nombre del archivo original. Puedes modificar este nombre a cualquier cosa que desees.
    }
  });
